<?php
/**
 * Secretary of CO: My Copies (personal copies of processed documents).
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ' . BASE_URL . '/secretary_co/copies.php');
    exit;
}

$copies = saved_copies($uid);
...
<?php endforeach; ?>
<?php if (!$copies): ?><tr><td colspan="6" class="text-center text-muted small py-4">No saved copies yet. Open a document you have processed and click <strong>Save Copy</strong>.</td></tr><?php endif; ?>
</tbody></table>
</div></div>
