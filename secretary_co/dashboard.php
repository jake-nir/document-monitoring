...
page_header('Secretary of CO Dashboard', 'dashboard', $user);
?>
            ...
            <div class="card-body p-0">
                ...
                <?php foreach ($incomingList as $r): ?>
                    <tr>
                        ...
                        <td class="small"><a class="btn btn-sm btn-outline-success py-0" href="<?= BASE_URL ?>/secretary_co/incoming.php">Receive</a></td>
                    </tr>
                <?php endforeach; ?>
            ...
            <div class="card-body p-0">
                ...
                <?php foreach ($awaiting as $r): ?>
                    <tr>
                        <td class="small"><a href="<?= BASE_URL ?>/view_document.php?id=<?= (int)$r['id'] ?>"><?= e($r['tracking_number']) ?></a></td>
                        <td><?= status_badge($r['current_status']) ?></td>
                        <td class="small"><a class="btn btn-sm btn-outline-primary py-0" href="<?= BASE_URL ?>/secretary_co/process.php?id=<?= (int)$r['id'] ?>">Process</a></td>
                    </tr>
                <?php endforeach; ?>
